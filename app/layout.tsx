...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: { template: "Alain | %s", default: "Alain" },
    ...
    <html className="[color-scheme:dark]">
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="h-full bg-[url('https://raw.githubusercontent.com/user28111999/portfolio/master/bg_gradient_h_500.jpg')] bg-top bg-no-repeat opacity-[0.3]" />
        </div>
